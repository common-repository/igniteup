            ...
            if ($subscription_u_meta != '1') :
                ...
                <div id="igniteup-subscription-form" class="support-box help-page-widget row-last-widget">
                    ...
                    <span id="ign-hide-after-success">
                        <input type="text" placeholder="<?php _e('Enter your email address', CSCS_TEXT_DOMAIN); ?>" value="<?php echo esc_html($curr_user_data->user_email); ?>" id="igniteup_admin_subscribe_email">
...
<!--            </div>-->
            ...
            <div class="support-box help-page-widget row-last-widget">
                ...
                <a href="https://www.paypal.com/donate/?hosted_button_id=4SQXCM5ELMY5N" target="_blank" class="button button-primary"><?php _e('Donate with PayPal', CSCS_TEXT_DOMAIN); ?></a>
            </div>
        </div>
    </div>
</div>
