                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <input type="text" class="regular-text" placeholder="" name='<?php echo $cs_subscribe_text; ?>' value='<?php echo esc_html(CSAdminOptions::getDefaultStrings('subscribe_text')); ?>'>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <input type="text" class="regular-text" placeholder="" name='<?php echo $cs_thank_msg; ?>' value='<?php echo wp_kses_post(CSAdminOptions::getDefaultStrings('alert_thankyou')); ?>'>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <input type="text" class="regular-text" placeholder="" name='<?php echo $cs_invalid_email_msg; ?>' value='<?php echo wp_kses_post(CSAdminOptions::getDefaultStrings('alert_error_invalid_email')); ?>'>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <input type="text" class="regular-text" placeholder="" name='<?php echo $cs_already_exists_email_msg; ?>' value='<?php echo wp_kses_post(CSAdminOptions::getDefaultStrings('alert_error_already_exists')); ?>'>
                        ...
                        foreach ($social as $icon) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    ?>
                                    <input type="text" class="regular-text" placeholder="http://<?php echo $social[$socialCount]; ?>.com/igniteup" name='<?php echo CSCS_GENEROPTION_PREFIX . 'social_' . $social[$socialCount]; ?>' value='<?php echo esc_url(get_option(CSCS_GENEROPTION_PREFIX . 'social_' . $social[$socialCount])); ?>'>
                    ...
                    <table class="form-table">
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <input type="text" class="regular-text" placeholder="" name='<?php echo $cs_receive_email_addr; ?>' value='<?php echo esc_html(get_option($cs_receive_email_addr, $admin_email)) ?>'>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <input type="text" class="regular-text" placeholder="" name="<?php echo $cs_contact_success_notce_name; ?>" value="<?php echo wp_kses_post(get_option($cs_contact_success_notce_name, $cs_contact_success_default_str)); ?>" >
